        ...
        <div class="md:w-1/2">
            <div class="p-6 z-10">
                ...
                <ButtonLarge
                    href="login"
                    variant=TEXT
                    className="w-full justify-center md:w-auto border bg-gray-verylight focus:border-primary sm:bg-transparent sm:border-transparent"
                >Login</ButtonLarge>
            </div>
        </div>
    </div>
...
<style>
    #hero::before {
        ...
        width: 100%;
        height: 100%;
        background-image: var(--notebook, none);
        filter: blur(.1px);
        background-position: 132% -98%;
